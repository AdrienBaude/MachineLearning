...
from keras.layers import Dense, Flatten, Conv2D, MaxPooling2D, Reshape, UpSampling2D
...
generator.add(Dense(14 * 14 * 128, activation="relu", input_shape=(100,)))
...
discriminator.add(Conv2D(128, 3, activation="relu", input_shape=x_train.shape[1:]))
